...
=======
SPACING = 100
>>>>>>> c7cf98bf3bcbcbe4ac4baa64a27c339d5cb8bdf3
...
class Plane():
    def __init__(self, canvas, x, y):
        self.canvas = canvas
<<<<<<< HEAD
        self.start_position = Point((x+124), y)
=======
...
<<<<<<< HEAD
            self.position.move(CANVAS_WIDTH+124, 40)
=======
...
<<<<<<< HEAD
        ...
        if(self.bomb.position.X>=1000 or self.bomb.position.Y>=700):
            self.bomb.outOfWindows()
=======
>>>>>>> c7cf98bf3bcbcbe4ac4baa64a27c339d5cb8bdf3
    ...
    def check_plane(self):
        ...
        for building in self.buildings:
            if (building.is_inside(plane_nose)
                ...
                self.game_over()
<<<<<<< HEAD
        if plane_body_bottom.getY() > 600 and plane_body_bottom.getX() < 20: 
=======
